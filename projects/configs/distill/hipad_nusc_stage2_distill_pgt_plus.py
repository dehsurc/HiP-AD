...
work_dir = "work_dirs/hipad_nusc_stage2_distill_pgt_plus"
...
wandb_name = "stage2_distill_pgt_plus"
log_config = dict(
    interval=50,
    hooks=[
...
pseudo_gt_weight = 1.0     # weight for pseudo GT detection loss
...
model = dict(
    ...
    head=dict(
        ...
        onedecoder_head=dict(
            ...
            distill_mode="pseudo_gt_plus",
            det_gt_loss_weight=1.0,
            pseudo_gt_weight=pseudo_gt_weight,
            # instance_bank
