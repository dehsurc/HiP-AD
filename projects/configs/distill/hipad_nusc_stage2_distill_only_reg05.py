...
work_dir = "work_dirs/hipad_nusc_stage2_distill_only_reg05"
...
wandb_name = "stage2_distill_only_reg05"
log_config = dict(
    interval=50,
    hooks=[
...
distill_alpha_reg = 0.5    # KD regression loss weight (5x base 0.1; aim KD reg ~2.7, closer to det_loss_box ~5.6)
