...
work_dir = "work_dirs/exp/E5_stage1_12ep_distill_wo_det"
...
wandb_project = "hipad"
wandb_name = "E5_stage1_12ep_distill_wo_det"
log_config = dict(
    interval=50,
    hooks=[
...
# ================== distillation config ========================
# Pseudo-GT only distillation. The teacher cache is converted from BEVFusion
# convention to HiP-AD convention at dataset load time (see
...
# det_gt_loss_weight=0.0 disables the real-GT branch entirely; only the pseudo-GT
# loss path drives the detection head. distill_score_thr=0.3 keeps only confident
# teacher proposals so weak/noisy ones don't pollute supervision.
