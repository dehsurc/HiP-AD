...
work_dir = "work_dirs/exp/PM_full_18ep_1_3_seed0"

version = 'trainval'
# 1/3 stratified-by-scene subset (seed 0); matches PM_det/map/motion.
...
wandb_project = "hipad"
wandb_name = "PM_full_18ep_1_3_seed0"
log_config = dict(
    interval=50,
    hooks=[
...
import os as _os
# Merged init: backbone + det_* + map_* + motion_* from PM_det / PM_map / PM_motion.
# Produced by tools/merge_pm_ckpts.py. Attention layers, plan_*, ego_* are
# freshly initialized.
load_from = "./work_dirs/exp/PM_merged_init.pth"
_resume = "./work_dirs/exp/PM_full_18ep_1_3_seed0/latest.pth"
