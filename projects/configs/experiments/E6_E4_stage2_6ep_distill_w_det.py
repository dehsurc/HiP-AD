...
work_dir = "work_dirs/exp/E6_E4_stage2_6ep_distill_w_det"
...
wandb_project = "hipad"
wandb_name = "E6_E4_stage2_distill_w_det"
log_config = dict(
    interval=50,
    hooks=[
...
load_from = "./work_dirs/exp/E4_stage1_12ep_distill_w_det/latest.pth"
resume_from = None
workflow = [("train", 1)]
