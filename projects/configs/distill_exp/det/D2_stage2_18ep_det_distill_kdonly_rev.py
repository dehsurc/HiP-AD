...
work_dir = "work_dirs/distill_exp/det/D2_stage2_18ep_det_distill_kdonly_rev"
...
wandb_name = "D2_stage2_18ep_det_distill_kdonly_rev"
log_config = dict(
    interval=50,
    hooks=[
...
load_from = "./work_dirs/distill_exp/det/D1_stage1_12ep_det_distill_kdonly_rev/latest.pth"
resume_from = None
