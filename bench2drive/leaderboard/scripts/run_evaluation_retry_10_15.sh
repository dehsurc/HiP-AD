#!/bin/bash
# Re-evaluate tasks 10~15 only (fresh checkpoints)
# Uses GPUs 0, 1, 2, 3 — runs 4 tasks at a time
...
try:
    ...
    if done_count >= total:
        ...
        dummy = {
            ...
            "meta": {"town": town, "skipped": "CARLA Signal 11 crash", "route_length": 0}
        }
